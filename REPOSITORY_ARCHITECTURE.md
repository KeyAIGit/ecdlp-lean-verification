...
| `index.html`, `research.html`, `research-os.html`, `about.html`, `governance.html`, `results.html`, `dashboard.html`, `explore.html`, `pilot.html`, `robots.txt`, `sitemap.xml` | `scripts/build_dashboard.py` compatibility entry point → `scripts/site_generator.py` |
