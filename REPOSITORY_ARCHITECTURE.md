...
| Public surfaces | Research-first homepage, verified-result browser, operator workspace, route explorer, external-pilot contract, and search-engine discovery files | `index.html`, `research.html`, `research-os.html`, `about.html`, `governance.html`, `research-scope.html`, `privacy.html`, `terms.html`, `security.html`, `contact.html`, `results.html`, `dashboard.html`, `explore.html`, `pilot.html`, `robots.txt`, `sitemap.xml`, `llms.txt`, `assets/`, `fonts/`, `CNAME` | Generate all public pages plus `robots.txt` and `sitemap.xml` through `scripts/site_generator.py`; canonical counters and research explanations must remain useful without JavaScript. |
...
The compact research map on `research-os.html` is a server-rendered projection owned by
...
| `index.html`, `research.html`, `research-os.html`, `about.html`, `governance.html`, `research-scope.html`, `privacy.html`, `terms.html`, `security.html`, `contact.html`, `results.html`, `dashboard.html`, `explore.html`, `pilot.html`, `robots.txt`, `sitemap.xml` | `scripts/build_dashboard.py` compatibility entry point → `scripts/site_generator.py` |
